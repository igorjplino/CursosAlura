...
namespace CasaDoCodigo
{
    ...
    public class HttpHelper : IHttpHelper
    {
        ...
        {
            return contextAccessor.HttpContext.Session.GetInt32($"pedidoId_{GetClientId()}");
        }
        ...
        {
            contextAccessor.HttpContext.Session.SetInt32($"pedidoId_{GetClientId()}", pedidoId);
        }

        public void ResetPedidoId()
        {
            contextAccessor.HttpContext.Session.Remove($"pedidoId_{GetClientId()}");
        }
    }
}
